...
const CONTENT = {
  ...
  people: [
    ...
    },
    {
      ...
      cs: { profession: "student, koordinátor Mladého Pirátstva", bio: "Ayudh je aktivní občan, student Fakulty sociálních věd Univerzity Karlovy, kde studuje Mezinárodní teritoriální studia a na Institutu komunikačních studií a žurnalistiky. Je koordinátorem Mladého Pirátstva v Jihomoravském kraji a bývalým 1. místopředsedou Krajského studentského sněmu JmK, největšího studentského parlamentu v České republice. Dlouhodobě se věnuje participaci mladých lidí, spolupracuje s krajskými institucemi a během války na Ukrajině pomáhal s integrací uprchlíků výukou češtiny. Je členem resortního týmu dopravy. Jeho prioritou je kvalitní veřejný prostor, moderní infrastruktura a vytváření podmínek, aby mladí lidé měli ve městě své místo, prostor pro aktivní život a větší možnost podílet se na jeho rozvoji. Ve volném čase rád cestuje a poznává nové země." },
      en: { profession: "student, Young Pirates coordinator", bio: "Ayudh is an engaged citizen and student at the Faculty of Social Sciences, Charles University, where he studies International Territorial Studies and Journalism at the Institute of Communication Studies. He is the coordinator of Young Pirates in the South Moravian Region and a former 1st Vice-Chair of the Regional Student Senate of the South Moravian Region — the largest student parliament in the Czech Republic. He has long focused on youth participation, works with regional institutions and during the war in Ukraine helped refugees integrate by teaching Czech. He is a member of the party's transport policy team. His priorities are quality public spaces, modern infrastructure and creating conditions for young people to have a real place in the city — space for an active life and a greater say in its development. In his free time he likes to travel and discover new countries." },
    },
    {
